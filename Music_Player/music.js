...
// this is used to show the avialable song list 
let song_lsit=document.getElementById("l0")
song_lsit.innerHTML=songs_list[0].name
song_lsit=document.getElementById("l1")
song_lsit.innerHTML=songs_list[1].name
song_lsit=document.getElementById("l2")
song_lsit.innerHTML=songs_list[2].name
song_lsit=document.getElementById("l3")
song_lsit.innerHTML=songs_list[3].name
song_lsit=document.getElementById("l4")
song_lsit.innerHTML=songs_list[4].name
song_lsit=document.getElementById("l5")
song_lsit.innerHTML=songs_list[5].name
song_lsit=document.getElementById("l6")
song_lsit.innerHTML=songs_list[6].name
song_lsit=document.getElementById("l7")
song_lsit.innerHTML=songs_list[7].name
song_lsit=document.getElementById("l8")
song_lsit.innerHTML=songs_list[8].name
song_lsit=document.getElementById("l9")
song_lsit.innerHTML=songs_list[9].name
